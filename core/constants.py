...
class ChatStatus(StrEnum):
    """Состояние подключения чата к боту.

    Записи чатов не удаляются: при исключении бота чат переходит в
    ``INACTIVE``, сохраняя настройки, репутацию и историю. При повторном
    добавлении бота чат оживает со всеми прежними данными.
    """

    ACTIVE = "active"  # бот в чате и работает
    INACTIVE = "inactive"  # бот удалён или вышел, данные сохранены
    MIGRATED = "migrated"  # группа стала супергруппой, данные перенесены
